...
public class TestCurve25519 {
    ...
    public void testPointMultiplication() throws DecoderException, InvalidParametersException {
        ...
        AffinePoint<BigInteger> expected = curve25519.decodePoint(Hex.decodeHex("02e3712d851a0e5d79b831c5e34ab22b41a198171de209b8b8faca23a11c624859"));
        ...
        expected = curve25519.decodePoint(Hex.decodeHex("02b5bea823d9c9ff576091c54b7c596c0ae296884f0e150290e88455d7fba6126f"));
        Assert.assertEquals(expected.x(), x.x());
    }
